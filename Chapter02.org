...
Methods used in the \CNSM model are easily portable to other sensory neural systems.
The variability of experimental data occurs through use of different animal species and strains 
in the literature.  Legacy data may also be affected by methods that adversely affect the neural responses in the networks, particularly anaesthetics in /in vivo/ studies.
