...
#+LATEX_HEADER:\graphicspath{{../MethodsChapter/gfx/}{../SimpleResponsesChapter/gfx/}{/media/data/Work/cnstellate/}{/media/data/Work/cnstellate/ResponsesNoComp/ModulationTransferFunction/}}
...
#+BEGIN_LaTeX
  ...
  %    \resizebox{3.5in}{!}{\includegraphics[keepaspectratio=true]{NoFigure}}
    \resizebox{0.95\textwidth}{!}{\input{../MethodsChapter/gfx/CNConn.pdf_tex}}
