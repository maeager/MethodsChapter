...
# % $0.8 \pm 0.2$ ms (37\degC mIPSCs MNTB rats: [\citenum{AwatramaniTurecekEtAl:2004}])
# % $1.1 \pm 0.2$ ms (37\degC evoked IPSCs MNTB rats: [\citenum{AwatramaniTurecekEtAl:2004}])
...
decay constants of miniature and evoked \IPSCs were $0.8 \pm 0.2$ ms and $1.1 \pm 0.2$ 
ms (37\degC), respectively \citep{AwatramaniTurecekEtAl:2004}.  \GABAa
...
dorsal \CN were measured using electric shocks and found to be approximately 1.0 ms, but ranged from 0.15 to 2 ms 
