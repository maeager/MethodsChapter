...
#+BEGIN_LaTeX
  \begin{figure}[htb]
    \centering
    {\figfont{A}\hfill Cat\hspace{0.5in}\figfont{B}\hfill Rat \hfill}\\ 
  \resizebox{7in}{!}{\includegraphics[keepaspectratio=true]{../SimpleResponsesChapter/gfx/AudiogramCompression.pdf}} \\
    ...
    Zilany AN models]{Animal auditory thresholds (audiograms) were used to
      ...
      the Bruce and Zilany AN models. The audiograms were collected from
      earlab.bu.edu (A) Compression values for cat using audiogram and rat (B).}
...
** Activation and De-activation Current Equations [APPENDIX]
   :PROPERTIES:
