...
* Neural Cell Models
  :PROPERTIES:
  :CUSTOM_ID: sec:Meth:cell-models
  :END:
...
* Connectivity and Organisation in the CNSM Model
   :PROPERTIES:
   :CUSTOM_ID: sec:Ch2:ConnectivityandTopology
   :END:
...
** Connectivity Parameters
   :PROPERTIES:
   :CUSTOM_ID:    sec:Ch2:ConnParameters
   :END:
...
** Delay and Latency Variables
   :PROPERTIES:
   :CUSTOM_ID: sec:Ch2:DelayLatency
   :END:
...
* Optimisation Techniques
  :PROPERTIES:
  :CUSTOM_ID: sec:Ch2:Optimisation
  :END:
